...
def plot2DResponses(datafn,respfn=None,wlfn=None,
...
#                    axr=fig.add_subplot(gs[:4,:])
                    ...
                    r5=axr.loglog(wlplst[zrxy],wlrpdict['resxy'][1][zrxy],
                                  ls='-.',marker='x',ms=5,color='cyan',
                                  mfc='cyan')
                    r6=axr.loglog(wlplst[zryx],wlrpdict['resyx'][1][zryx],
                                  ls='-.',marker='x',ms=5,color='orange',
                                  mfc='orange')
...
#    print ylimits
    ...
    slabel=[slst[ss] for ss in range(0,ns,ml)]
